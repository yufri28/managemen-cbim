  ...
  <head>
      ...
      <link rel="shortcut icon" href="<?=base_url()?>assets/media/logos/logo-cbim.png" />
      <!--begin::Fonts-->
      ...
      <div class="page d-flex flex-row flex-column-fluid">
          ...
          <div id="kt_aside" class="aside pb-5 pt-5 pt-lg-0" data-kt-drawer="true" data-kt-drawer-name="aside"
              ...
              <div class="aside-logo py-8" id="kt_aside_logo">
                  <!--begin::Logo-->
                  <a href="<?=base_url()?><?=base_url()?>demo6/dist/index.html" class="d-flex align-items-center">
                      <img alt="Logo" src="<?=base_url()?>assets/media/logos/logo-cbim.png" class="h-45px logo" />
                  </a>
                  <!--end::Logo-->
              </div>
              <!--end::Brand-->
                      ...
                      <div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold"
                          ...
                          <div class="menu-item py-2">
                              <a class="menu-link <?= $this->uri->segment(1) == 'menu' ? 'active' : '' ?> menu-center"
                                  ...
                                  <span class="menu-title text-center">Manajemen Menu</span>
                              </a>
                          </div>
                          <div class="menu-item py-2">
                              <a class="menu-link <?= $this->uri->segment(1) == 'users' ? 'active' : '' ?> menu-center"
                                  href="<?=base_url('users');?>" data-bs-trigger="hover" data-bs-dismiss="click"
                                  data-bs-placement="right">
                                  <span class="menu-icon me-0">
                                      <i class="bi bi-people fs-2"></i>
                                  </span>
                                  <span class="menu-title text-center">Manajemen User</span>
                              </a>
                          </div>
                          <?php endif; ?>
                      </div>
                      ...
                      <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                                  ...
                                  <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                      ...
                                      <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                          ...
                                          <a class="menu-link active py-3"
                                              href="<?=base_url()?><?=base_url()?>demo6/dist/index.html">
                                          ...
                                          <div
                                              ...
                                              <div class="menu-item">
                                                  <a class="menu-link py-3"
                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/dashboards/compact.html">
                                                      <span class="menu-icon">
                                              ...
                                              <div class="menu-item">
                                                  <a class="menu-link py-3"
                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/dashboards/minimal.html">
                                                      <span class="menu-icon">
                                              ...
                                              <div class="menu-item">
                                                  <a class="menu-link py-3"
                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/landing.html">
                                                      <span class="menu-icon">
                                          ...
                                          <div
                                                  ...
                                                  <div
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/profile/overview.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/profile/projects.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/profile/campaigns.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/profile/documents.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/profile/connections.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/profile/activity.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/list.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/project.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/targets.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/budget.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/users.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/files.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/activity.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Activity</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/settings.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/wizards/horizontal.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/wizards/vertical.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/search/horizontal.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Horizontal</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/search/vertical.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Vertical</span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/blog/home.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/blog/post.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/company/about.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/company/pricing.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/company/contact.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/company/team.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/company/licenses.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/company/sitemap.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/careers/list.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/careers/apply.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/faq/classic.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/pages/faq/extended.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                              ...
                                              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                  ...
                                                  <div
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/account/overview.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                              <span class="menu-title">Overview</span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/account/settings.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                              <span class="menu-title">Settings</span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/account/security.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/account/billing.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/account/statements.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/account/referrals.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/account/api-keys.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                  ...
                                                  <div
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/basic/sign-in.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/basic/sign-up.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/basic/two-steps.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/basic/password-reset.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/basic/new-password.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/aside/sign-in.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Sign-in</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/aside/sign-up.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Sign-up</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/aside/two-steps.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Two-steps</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/aside/password-reset.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Password Reset</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/aside/new-password.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">New Password</span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/dark/sign-in.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Sign-in</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/dark/sign-up.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Sign-up</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/dark/two-steps.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Two-steps</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/dark/password-reset.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Password Reset</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/flows/dark/new-password.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">New Password</span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/extended/multi-steps-sign-up.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/extended/free-trial-sign-up.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/extended/coming-soon.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/general/welcome.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/general/verify-email.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/general/password-confirmation.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/general/deactivation.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/general/error-404.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/general/error-500.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/email/verify-email.html"
                                                                      target="blank">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/email/invitation.html"
                                                                      target="blank">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/email/password-reset.html"
                                                                      target="blank">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/authentication/email/password-change.html"
                                                                      target="blank">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                  ...
                                                  <div
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/general/invite-friends.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/general/view-users.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/general/upgrade-plan.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/general/share-earn.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/forms/new-target.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/forms/new-card.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/forms/new-address.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/forms/create-api-key.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/wizards/two-factor-authentication.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/wizards/create-app.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/wizards/create-account.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/wizards/create-project.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/wizards/offer-a-deal.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/search/users.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                                      <span class="menu-title">Users</span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/modals/search/select-location.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                              ...
                                              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                  ...
                                                  <div
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/widgets/lists.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/widgets/statistics.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/widgets/charts.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/widgets/mixed.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/widgets/tables.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/widgets/feeds.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                          ...
                                          <div
                                                  ...
                                                  <div
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/user-management/users/list.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/user-management/users/view.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/user-management/roles/list.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/user-management/roles/view.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/user-management/permissions.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                  ...
                                                  <div
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/invoices/view/invoice-1.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/invoices/view/invoice-2.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/invoices/create.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                              ...
                                              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                  ...
                                                  <div
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/support-center/overview.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                              <span class="menu-title">Overview</span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/support-center/tickets/list.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/support-center/tickets/view.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                          ...
                                                          <div
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/support-center/tutorials/list.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                              ...
                                                              <div class="menu-item">
                                                                  <a class="menu-link py-3"
                                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/apps/support-center/tutorials/post.html">
                                                                      <span class="menu-bullet">
                                                                          <span class="bullet bullet-dot"></span>
                                                                      </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/support-center/faq.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                              <span class="menu-title">FAQ</span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/support-center/licenses.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                              <span class="menu-title">Licenses</span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/support-center/contact.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                              <span class="menu-title">Contact Us</span>
                                              ...
                                              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                  ...
                                                  <div
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/customers/getting-started.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/customers/list.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/customers/view.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                              ...
                                              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                  ...
                                                  <div
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/subscriptions/getting-started.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                              <span class="menu-title">Getting Started</span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/subscriptions/list.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/subscriptions/add.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/subscriptions/view.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                              ...
                                              <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                                  ...
                                                  <div
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/chat/private.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/chat/group.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                                      ...
                                                      <div class="menu-item">
                                                          <a class="menu-link py-3"
                                                              href="<?=base_url()?><?=base_url()?>demo6/dist/apps/chat/drawer.html">
                                                              <span class="menu-bullet">
                                                                  <span class="bullet bullet-dot"></span>
                                                              </span>
                                      ...
                                      <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                                          ...
                                          <div
                                              ...
                                              <div class="menu-item">
                                                  <a class="menu-link py-3"
                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/documentation/base/utilities.html"
                                              ...
                                              <div class="menu-item">
                                                  <a class="menu-link py-3"
                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/documentation/getting-started.html"
                                              ...
                                              <div class="menu-item">
                                                  <a class="menu-link py-3"
                                                      href="<?=base_url()?><?=base_url()?>demo6/dist/documentation/getting-started/changelog.html">
                                                      <span class="menu-icon">
                                          ...
                                          <div data-kt-search-element="content"
                                                  ...
                                                  <div data-kt-search-element="results" class="d-none">
                                                      ...
                                                      <div class="scroll-y mh-200px mh-lg-350px">
                                                          ...
                                                          <a href="#"
                                                              ...
                                                              <!--begin::Symbol-->
                                                              <div class="symbol symbol-40px me-4">
                                                                  <img src="<?=base_url()?>assets/media/avatars/150-3.jpg"
                                                                      alt="" />
                                                              </div>
                                                              <!--end::Symbol-->
                                                              <!--begin::Title-->
                                                          ...
                                                          <a href="#"
                                                              ...
                                                              <!--begin::Symbol-->
                                                              <div class="symbol symbol-40px me-4">
                                                                  <img src="<?=base_url()?>assets/media/avatars/150-8.jpg"
                                                                      alt="" />
                                                              </div>
                                                              <!--end::Symbol-->
                                                              <!--begin::Title-->
                                                          ...
                                                          <a href="#"
                                                              ...
                                                              <!--begin::Symbol-->
                                                              <div class="symbol symbol-40px me-4">
                                                                  <img src="<?=base_url()?>assets/media/avatars/150-12.jpg"
                                                                      alt="" />
                                                              </div>
                                                              <!--end::Symbol-->
                                                              <!--begin::Title-->
                                                              ...
                                                              <div class="symbol symbol-40px me-4">
                                                                  <span class="symbol-label bg-light">
                                                                      <img class="w-20px h-20px"
                                                                          src="<?=base_url()?>assets/media/svg/brand-logos/volicity-9.svg"
                                                                          alt="" />
                                                                  </span>
                                                              </div>
                                                              <!--end::Symbol-->
                                                          ...
                                                          <a href="#"
                                                              ...
                                                              <div class="symbol symbol-40px me-4">
                                                                  <span class="symbol-label bg-light">
                                                                      <img class="w-20px h-20px"
                                                                          src="<?=base_url()?>assets/media/svg/brand-logos/tvit.svg"
                                                                          alt="" />
                                                                  </span>
                                                              </div>
                                                              <!--end::Symbol-->
                                                          ...
                                                          <a href="#"
                                                              ...
                                                              <div class="symbol symbol-40px me-4">
                                                                  <span class="symbol-label bg-light">
                                                                      <img class="w-20px h-20px"
                                                                          src="<?=base_url()?>assets/media/svg/misc/infography.svg"
                                                                          alt="" />
                                                                  </span>
                                                              </div>
                                                              <!--end::Symbol-->
                                                          ...
                                                          <a href="#"
                                                              ...
                                                              <div class="symbol symbol-40px me-4">
                                                                  <span class="symbol-label bg-light">
                                                                      <img class="w-20px h-20px"
                                                                          src="<?=base_url()?>assets/media/svg/brand-logos/leaf.svg"
                                                                          alt="" />
                                                                  </span>
                                                              </div>
                                                              <!--end::Symbol-->
                                                          ...
                                                          <a href="#"
                                                              ...
                                                              <div class="symbol symbol-40px me-4">
                                                                  <span class="symbol-label bg-light">
                                                                      <img class="w-20px h-20px"
                                                                          src="<?=base_url()?>assets/media/svg/brand-logos/tower.svg"
                                                                          alt="" />
                                                                  </span>
                                                              </div>
                                                              <!--end::Symbol-->
                                              ...
                                              <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                                  ...
                                                  <div class="d-flex justify-content-end">
                                                      ...
                                                      <a href="<?=base_url()?><?=base_url()?>demo6/dist/pages/search/horizontal.html"
                          ...
                          ">
                                          ...
                                          <div class="row g-0">
                                              <!--begin:Item-->
                                              <div class="col-6">
                                                  <a href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/budget.html"
                                              ...
                                              <!--begin:Item-->
                                              <div class="col-6">
                                                  <a href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/settings.html"
                                              ...
                                              <!--begin:Item-->
                                              <div class="col-6">
                                                  <a href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/list.html"
                                              ...
                                              <!--begin:Item-->
                                              <div class="col-6">
                                                  <a href="<?=base_url()?><?=base_url()?>demo6/dist/pages/projects/users.html"
                                                  ...
                                                  <div class="d-flex flex-column px-9">
                                                      ...
                                                      <div class="text-center px-4">
                                                          <img class="mw-100 mh-200px" alt="image"
                                                              src="<?=base_url()?>assets/media/illustrations/sketchy-1/1.png" />
                                                      </div>
                                                      <!--end::Illustration-->
                                                  </div>
                                                  <!--end::Wrapper-->
                                  ...
                                  <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                      ...
                                      <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                          ...
                                          <div class="menu-item px-5">
                                              <a href="<?=base_url()?><?=base_url()?>demo6/dist/account/overview.html"
                                          ...
                                          <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                              ...
                                              <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                  <!--begin::Menu item-->
                                                  <div class="menu-item px-3">
                                                      <a href="<?=base_url()?><?=base_url()?>demo6/dist/account/referrals.html"
                                                          class="menu-link px-5">Referrals</a>
                                                  </div>
                                                  <!--end::Menu item-->
                                                  <!--begin::Menu item-->
                                                  <div class="menu-item px-3">
                                                      <a href="<?=base_url()?><?=base_url()?>demo6/dist/account/billing.html"
                                                          class="menu-link px-5">Billing</a>
                                                  </div>
                                                  <!--end::Menu item-->
                                                  <!--begin::Menu item-->
                                                  <div class="menu-item px-3">
                                                      <a href="<?=base_url()?><?=base_url()?>demo6/dist/account/statements.html"
                                          ...
                                          <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                              ...
                                              <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                  <!--begin::Menu item-->
                                                  <div class="menu-item px-3">
                                                      <a href="<?=base_url()?><?=base_url()?>demo6/dist/account/settings.html"
                                                  ...
                                                  <div class="menu-item px-3">
                                                      <a href="<?=base_url()?><?=base_url()?>demo6/dist/account/settings.html"
                                                          ...
                                                          <span class="symbol symbol-20px me-4">
                                                              <img class="rounded-1"
                                                                  src="<?=base_url()?>assets/media/flags/spain.svg"
                                                                  alt="" /> </span>Spanish</a>
                                                  </div>
                                                  <!--end::Menu item-->
                                                  <!--begin::Menu item-->
                                                  <div class="menu-item px-3">
                                                      <a href="<?=base_url()?><?=base_url()?>demo6/dist/account/settings.html"
                                                          ...
                                                          <span class="symbol symbol-20px me-4">
                                                              <img class="rounded-1"
                                                                  src="<?=base_url()?>assets/media/flags/germany.svg"
                                                                  alt="" />
                                                          </span>German</a>
                                                  </div>
                                                  <!--end::Menu item-->
                                                  ...
                                                  <div class="menu-item px-3">
                                                      <a href="<?=base_url()?><?=base_url()?>demo6/dist/account/settings.html"
                                                          ...
                                                          <span class="symbol symbol-20px me-4">
                                                              <img class="rounded-1"
                                                                  src="<?=base_url()?>assets/media/flags/japan.svg"
                                                                  alt="" /> </span>Japanese</a>
                                                  </div>
                                                  <!--end::Menu item-->
                                                  <!--begin::Menu item-->
                                                  <div class="menu-item px-3">
                                                      <a href="<?=base_url()?><?=base_url()?>demo6/dist/account/settings.html"
                                                          ...
                                                          <span class="symbol symbol-20px me-4">
                                                              <img class="rounded-1"
                                                                  src="<?=base_url()?>assets/media/flags/france.svg"
                                                                  alt="" />
                                                          </span>French</a>
                                                  </div>
                                                  <!--end::Menu item-->
                                          ...
                                          <!--begin::Menu item-->
                                          <div class="menu-item px-5">
                                              <a href="<?=base_url('logout')?>" class="menu-link px-5">Log Out</a>
                                          </div>
                                          <!--end::Menu item-->
                                          <!--begin::Menu separator-->
                                          <div class="separator my-2"></div>
                                              ...
                                              <div class="menu-content px-5">
                                                  <label
                                                      ...
                                                      <input class="form-check-input w-30px h-20px" type="checkbox"
                                                          ...
                                                          data-kt-url="<?=base_url()?><?=base_url()?>demo6/dist/index.html" />
