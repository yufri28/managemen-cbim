        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="g-5 gx-xxl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Parent Menu</span>
                            <span class="text-muted mt-1 fw-bold fs-7"><?=$jumlah_parent_menu;?> Menu</span>
                        </h3>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-muted fw-bold text-center">
                                            <span class="text-dark fw-bold text-center d-block fs-7">Link Menu</span>
                                            <?=$menu['link_parent'] != null ? $menu['link_parent']:'-';?>
                                        </td>
                                        <td class="text-end">
                                            <button data-bs-toggle="modal" data-bs-target="#lihat<?=$menu['id_menu'];?>"
                                                type="button"
                                            ...
                                            <a href="<?=base_url('menu/add-akses/'.$menu['id_menu']);?>"
                                                class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                <span class="svg-icon svg-icon-3">
                                            ...
                                            <a href="<?=base_url('menu/edit-menu/'.$menu['id_menu']);?>"
                                                class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <button data-bs-toggle="modal" data-bs-target="#hapus<?=$menu['id_menu'];?>"
                                                type="button"
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Sub Menu</span>
                            <span class="text-muted mt-1 fw-bold fs-7"><?=$jumlah_sub_menu;?> Menu</span>
                        </h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary mb-1 fs-6"><?=$menu['nama_menu']?></a>
                                                    <a href="#"
                                                        class="text-muted text-hover-primary fw-bold text-muted d-block fs-7">
                                                        <span class="text-dark">Parent Menu</span>:
                                                        <?=$menu['short_name'];?></a>
                                                </div>
                                            </div>
                                        </td>
...
<!-- begin::Modal Hapus Menu -->
<?php foreach ($parentMenu as $key => $menu):?>
<div class="modal fade" id="hapus<?=$menu['id_menu'];?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?=base_url('menu/hapus_parent');?>" method="post">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Menu</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Anda yakin ingin hapus menu <strong><?=$menu['short_name'];?></strong> ?</p>
...
<!-- begin::Modal Akses Pengguna -->
<?php foreach ($parentMenu as $key => $menu):?>
<div class="modal fade" id="lihat<?=$menu['id_menu'];?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Akses Pengguna</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <ol>
                    ...
                    <li>
                        <?= $pengguna['role']; ?>
                        <button type="button" class="btn-close fs-8 delete-button"
                            data-id="<?= $pengguna['id']; ?>"></button>
                    </li>
                    <?php endforeach; ?>
                </ol>
            </div>
